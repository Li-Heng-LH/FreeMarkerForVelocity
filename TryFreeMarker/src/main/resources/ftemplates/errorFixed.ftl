<#-- This is generated from cavalry and with errors fixed -->
<html>
    ...
    <table style="width: 100%">
        <tr>
            <#if didPass>                <th style= "background-color: #006600; color: #ffffff; height:60px; margin:6px; border: 1px solid black"> Status: Pass </th>
            <#else>                <th style= "background-color: #B20000>; color: #ffffff; height:60px; margin:6px; border: 1px solid black"> Status: Fail </th>
            </#if>        </tr>
        ...
        <tr><td>
            ...
            <#else>
                ...
                <table style="border: 1px solid black; border-collapse: collapse; width: 100%; font-size:100%">
                    <thead>
                    <#-- Add Header Row -->                    <tr style = "background-color: #A09FDA">
                        <#list summaryHeaderTokens as headerToken >                            <th style="border: 1px solid black; padding:5px"> ${headerToken} </th>
                        </#list>                    </tr>
                    </thead>
